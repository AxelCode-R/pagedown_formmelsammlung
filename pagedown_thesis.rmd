...
#http://www.andreacirillo.com/2019/01/27/a-quick-ride-on-pagedown-create-pdf-from-rmarkdown/
#pagedown::chrome_print("pagedown_thesis.html")
#xaringan::inf_mr("pagedown_thesis.rmd")
...
# ```{r download_button, echo=FALSE}
# temp <- list.files("R")
# downloadthis::download_file(
#   path = "pagedown_thesis.pdf",
